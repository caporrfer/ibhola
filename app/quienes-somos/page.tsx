...
export default function Page() { return <InteriorPage eyebrow="Nuestra historia" title="Experiencia que se nota cuando te asesoramos." intro="IBHOLA nace de la experiencia real sobre asfalto y montaña y de las ganas de ofrecer el tipo de atención que todo corredor agradece.">
