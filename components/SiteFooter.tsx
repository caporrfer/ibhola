  ...
  return <>
    <footer className="footer"><Topography className="footer__topography" />
      <div className="container footer__grid">
        ...
        <div><h2>Explora</h2><a href={`${basePath}/quienes-somos/`}>Quiénes somos</a><a href={`${basePath}/que-hacemos/`}>Qué hacemos</a><a href={`${basePath}/catalogo/`}>Catálogo</a><a href={`${basePath}/eventos/`}>Eventos</a></div>
