    ...
    <main>
      <section className="hero" id="inicio"><Topography className="hero__topography" />
        <div className="hero__layout container-wide">
          ...
          <div className="hero__visual"><div className="hero__photo"><Image src={imagePath("/images/hero-comunidad-atardecer.jpg")} alt="Corredores de IBHOLA contemplando el atardecer en la montaña" fill priority quality={92} sizes="(max-width: 900px) 100vw, 54vw" /></div></div>
        </div>
      </section>
      ...
      <section className="about section" id="presentacion"><div className="container about__intro">
        ...
        <div className="about__visual reveal"><div className="about__image"><Image src={imagePath("/images/miguel-pereira-retrato.jpg")} alt="Miguel Ángel Pereira, propietario de IBHOLA Trail Running" fill quality={92} sizes="(max-width: 850px) 100vw, 52vw" /></div></div>
      </div>
      </section>
