  ...
  return <>
    ...
    <main>
      ...
      <section className="about section" id="presentacion"><div className="container about__intro">
        ...
        <div className="about__visual reveal"><div className="about__image"><Image src={imagePath("/images/corredor-ai-enhanced.webp")} alt="Propietario de IBHOLA durante una carrera" fill quality={92} sizes="(max-width: 850px) 100vw, 52vw" /></div></div>
      </div>
      </section>
