    ...
    <main>
      <section className="hero" id="inicio"><Topography className="hero__topography" />
        <div className="hero__layout container-wide">
          ...
          <div className="hero__visual"><div className="hero__photo"><Image src={imagePath("/images/hero-comunidad-atardecer.jpg")} alt="Equipo de IBHOLA contemplando la montaña al atardecer" fill priority quality={92} sizes="(max-width: 900px) 100vw, 54vw" /></div></div>
        </div>
      </section>
