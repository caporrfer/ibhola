  ...
  return <>
    ...
    <main>
      ...
      <section className="social-feed section"><div className="container social-feed__grid">
        <div className="social-feed__copy reveal"><p className="eyebrow"><span /> Instagram</p><h2>Lo último de <em>IBHOLA.</em></h2><p>Material recién llegado, carreras, encuentros y el día a día de nuestra comunidad. Aquí puedes ver directamente nuestras publicaciones más recientes.</p>
          <div className="social-feed__photo"><Image src={imagePath("/images/equipacion.webp")} alt="Comunidad de corredores de IBHOLA" fill sizes="(max-width: 850px) 100vw, 48vw" /><div><InstagramLogo size={23} /><span>Síguenos<br /><b>{business.social.instagramHandle}</b></span></div></div>
          <a className="social-feed__facebook" href={business.social.facebook} target="_blank" rel="noreferrer"><FacebookLogo size={18} /> También estamos en Facebook <ArrowUpRight size={17} /></a>
        </div>
        <div className="instagram-feed reveal"><div className="instagram-feed__heading"><i><InstagramLogo size={22} /></i><div><small>Publicaciones recientes</small><strong>{business.social.instagramHandle}</strong></div><a href={business.social.instagram} target="_blank" rel="noreferrer">Abrir perfil <ArrowUpRight size={15} /></a></div><iframe src="https://www.instagram.com/ibhola/embed/" title="Últimas publicaciones de IBHOLA en Instagram" width="500" height="690" loading="lazy" /></div>
      </div></section>
