...
export function HomePage() {
  return <>
    ...
    <main>
      ...
      <div className="container section-cta"><a className="button" href={link("/que-hacemos/")}>Ver todo lo que hacemos <ArrowRight size={17} /></a></div></section>
      ...
      <section className="contact section" id="contacto"><div className="container"><div className="contact__heading reveal"><p className="eyebrow"><span /> Dónde estamos</p><h2>Visítanos en <em>Corrales.</em></h2><p>Ven a la tienda, llámanos o escríbenos antes de desplazarte.</p></div>
        ...
        <div className="contact-form-section reveal"><div><p className="eyebrow"><span /> Contacto</p><h2>¿En qué podemos ayudarte?</h2><p>Cuéntanos qué material buscas o qué duda tienes.</p></div><ContactForm /></div>
      </div></section>
    </main><SiteFooter />
  </>;
}
